...
def print_model(service, model_type, features_iv, features_tt, auc_iv, auc_tt, sample_size):
    # asdsad
...
data_path = '/home/sergiov/Desktop/full_data_random.csv'
...
for i in range(0, len(file_paths), 2):
    ...
    # Write document
    print_model(service, model_type, features_iv, features_tt, auc_iv, auc_tt, sample_size)
